...
; --- ISR Timer0 -----------------------------------------------------
    banksel INTCON
    btfss INTCON,2 ; ((INTCON) and 07Fh), 2?
    goto ISR_End
    bcf INTCON,2 ; clear ((INTCON) and 07Fh), 2
...
vitesse4:
 ...
 Toggle_LED:
    ...
    ; --- Toggle ((PORTB) and 07Fh), 3, forcer ((PORTB) and 07Fh), 4 à 0 (exemple propre sans RMW piégeux) ---
    banksel PORTB
    movf PORTB,W
    btfss LED,0
    goto Diode1
    goto Diode2
Diode1:
    andlw 11101111B ; ((PORTB) and 07Fh), 4=0
    xorlw 00001000B ; toggle ((PORTB) and 07Fh), 3
    movwf PORTB
    return
Diode2:
    andlw 11110111B ; ((PORTB) and 07Fh), 3=0
    xorlw 00010000B ; toggle ((PORTB) and 07Fh), 4
    movwf PORTB
    return
...
init_pic:
    ...
    ; LEDs ((PORTB) and 07Fh), 3/((PORTB) and 07Fh), 4 en sortie
    banksel TRISB
    bcf TRISB,3
    bcf TRISB,4
    ...
    ; OPTION_REG bits: RBPU ((OPTION_REG) and 07Fh), 6 ((OPTION_REG) and 07Fh), 5 ((OPTION_REG) and 07Fh), 4 ((OPTION_REG) and 07Fh), 3 ((OPTION_REG) and 07Fh), 2 ((OPTION_REG) and 07Fh), 1 ((OPTION_REG) and 07Fh), 0
    ...
    ; Flags + interruptions
    banksel INTCON
    bcf INTCON,2 ; ((INTCON) and 07Fh), 2=0
    bsf INTCON,5 ; ((INTCON) and 07Fh), 5=1 (enable)
    bsf INTCON,7 ; ((INTCON) and 07Fh), 7=1
